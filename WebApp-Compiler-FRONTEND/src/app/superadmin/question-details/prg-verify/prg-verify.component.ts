...
@Component({
  selector: 'app-prg-verify',
  templateUrl: './prg-verify.component.html',
  styleUrls: ['./prg-verify.component.css']
})
export class PrgVerifyComponent implements OnInit {
  ...
  verify(){
    $('#prgverify-question-modal').modal('show');
  }
  cancelVerify(){
    $('#prgverify-question-modal').modal('hide');
  }
  confirmVerify(){
    this.verifyQuestion();
    $('#prgverify-question-modal').modal('hide');
